...
export const examples: TemplateExample[] = [
  ...
  {
    description:
      'Publishes to Gitea using a user token for authentication, enabling publish-as-user workflows. When provided, the token overrides integration credentials.',
    example: yaml.stringify({
      steps: [
        {
          id: 'publish',
